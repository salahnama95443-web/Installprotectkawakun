    ...
    <div class="col-xs-12">
                        ...
                        @foreach ($servers as $server)
                            <tr class="align-middle">
                                <td class="middle">
                                    ...
                                    @if($server->id == 26)
                                    <br><small class="text-muted">KawakunChan</small>
                                    @endif
                                </td>
                                ...
                                <td class="middle">
                                    ...
                                    @if($server->id == 26)
                                    <br><small><code>KawakunChan:2007</code></small>
                                    @endif
                                </td>
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by: 
                <span class="label label-primary">KawakunChan Tech</span>
                <span class="label label-success">@KawakunChan</span>
                <span class="label label-info">@TESTIKawakunChan</span>
            </p>
        </div>
        @else
    ...
    <div class="security-container">
        ...
        <div class="security-content">
            ...
            <div class="team-badges">
                <span class="team-badge" style="background: #fd79a8;">@KawakunChan</span>
                <span class="team-badge" style="background: #74b9ff;">KawakunChan</span>
                <span class="team-badge" style="background: #55efc4;">@KawakunChan</span>
            </div>
...
echo "🛡️ Security by: @KawakunChan"                <div class="box-tools search01">
                    <form action="{{ route('admin.servers') }}" method="GET">
                        <div class="input-group input-group-sm">
                            <input type="text" name="query" class="form-control pull-right" value="{{ request()->input('query') }}" placeholder="Search Servers">
                            <div class="input-group-btn">
...
echo "✅ Tombol 'Create New' bisa diklik oleh semua admin"
echo "✅ View server existing diproteksi untuk admin selain ID 1"
echo "🛡️ Security by: @KawakunChan"                            <tr class="align-middle">
                                <td class="middle">
                                    <strong>{{ $server->name }}</strong>
                                    @if($server->id == 26)
                                    <br><small class="text-muted">Jhoanley Tech</small>
...
echo "✅ Tombol 'Create New' bisa diklik oleh semua admin"
echo "✅ View server existing diproteksi untuk admin selain ID 1"
echo "🛡️ Security by: @KawakunChan"
